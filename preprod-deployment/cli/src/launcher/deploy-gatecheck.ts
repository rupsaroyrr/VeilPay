...
async function main() {
  ...
  try {
    ...
    console.log("Explorer:", `https://preprod.midnightexplorer.com/contracts/${formattedAddress}`);
    console.log("================================================================================");

    const deploymentInfo = {
      network: "preprod",
      contractAddress,
      explorerUrl: `https://preprod.midnightexplorer.com/contracts/${formattedAddress}`,
